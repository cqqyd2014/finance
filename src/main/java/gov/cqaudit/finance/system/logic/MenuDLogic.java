...
public class MenuDLogic {
	public static gov.cqaudit.finance.system.model.MenuD getModelFromView(gov.cqaudit.finance.hibernate.entities.VUserMenuD vumd){
	...
	public static java.util.ArrayList<gov.cqaudit.finance.system.model.MenuD> getArrayListModelFromArrayListView(java.util.ArrayList<gov.cqaudit.finance.hibernate.entities.VUserMenuD> vumds){
