package gov.cqaudit.finance.data.public_trade_detail.action;
...
public class PublicTradeDetailInitAction extends GetDataInitAction{
	
	
	@Actions({     
	    
		 @Action( //表示请求的Action及处理方法  
		            value="public_trade_detail_init",  //表示action的请求名称  
		            results={  //表示结果跳转  
		                    @Result(name="success",location="/WEB-INF/data/data_main.jsp")}, interceptorRefs = {
									@InterceptorRef("authorityInterceptor") })

	})
	@Authority(module="public_trade_detail_init", privilege="*",error_url="authority_error") 
			@Override
			public String execute() {
				// TODO Auto-generated method stub
		//设置参数
		this.setView_name("v_data_core_public_account_trade_detail");
