...
public class CenterFrameAction extends LoginedInitAction  {
...
java.util.ArrayList<gov.cqaudit.finance.system.model.MenuM> menu;
	...
	@Actions({     
		 ...
		 @Action( //表示请求的Action及处理方法  
		            ...
		            results={  //表示结果跳转  
		                    @Result(name="success",location="/WEB-INF/frame/center.jsp"),  
	...
	@Authority(module="centerframe", privilege="*",error_url="authority_error") 
	@Override
