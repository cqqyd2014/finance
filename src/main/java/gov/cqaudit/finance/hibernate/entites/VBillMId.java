...
public class VBillMId implements java.io.Serializable {
	...
	public VBillMId(BigDecimal picsNum, String deptName, String createUserId, Date createDat, String billStatus,
			String contractName, String contractTell, String contractMail, String auditUserId, Date lastAuditDat,
			String proName, String billUuid, String deptId, Date lastModifyDat, String searchReason,
			String downloadUserId, Date downloadDat, String downloadUuid, Boolean effective, String createUserName,
			String auditUserName, String downloadUserName) {
	...
	public boolean equals(Object other) {
		...
		return ((this.getPicsNum() == castOther.getPicsNum()) || (this.getPicsNum() != null
