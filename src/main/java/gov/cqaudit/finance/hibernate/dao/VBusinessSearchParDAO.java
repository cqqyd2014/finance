...
public class VBusinessSearchParDAO {
	...
	public static java.util.ArrayList<gov.cqaudit.finance.hibernate.entities.VBusinessSearchPar> getEntityByBusinessCode(Session session, String business_code) {
